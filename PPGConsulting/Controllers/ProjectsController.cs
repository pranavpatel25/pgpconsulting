...
namespace PPGConsulting.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.StudyID = new SelectList(db.Studies, "StudyID", "ProjectCode");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "ProjectID,StudyID,EmployeeID,StartDate,EndDate")] Project project)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProjectID,StudyID,EmployeeID,StartDate,EndDate")] Project project)
        {
            if (ModelState.IsValid)
            {
